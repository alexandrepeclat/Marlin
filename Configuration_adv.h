 ...
 */
#define E0_AUTO_FAN_PIN P2_04 //ALEX
...
#define HOMING_BUMP_MM      { 0, 0, 2 }       // (mm) Backoff from endstops after first bump //ALEX (défaut { 5, 5, 2 })
#define HOMING_BUMP_DIVISOR { 2, 2, 8 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate) //ALEX (défaut { 2, 2, 4 })
...
//#define LCD_SHOW_E_TOTAL
   ...
   */
  #define SDCARD_CONNECTION LCD //ALEX SD
 ...
 */
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       580 //ALEX (à voir 760 pour X/Y/Z et 900 pour E possible ?)
   ...
   */
  //#define SENSORLESS_HOMING // StallGuard capable drivers only //ALEX

  #if EITHER(SENSORLESS_HOMING, SENSORLESS_PROBING)
    // TMC2209: 0...255. TMC2130: -64...63
    #define X_STALL_SENSITIVITY  50 //ALEX (8 par défaut y aussi)
